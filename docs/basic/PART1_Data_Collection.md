...
```bash
pip install pandas numpy requests python-dotenv tqdm yfinance
```

> 데이터 소스는 FMP를 기본으로 통일했으며, 옵션 체인만 yfinance를 유지합니다.
...
> 최신 구현: `us_market/create_us_daily_prices.py`
